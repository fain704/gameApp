...
var battleMusic = new Audio("/public/sounds/musicBattle.mp3");
var introMusic = new Audio("/public/sounds/musicIntro.mp3");

var PlayIntroMusic = function () {
...
var StopIntroMusic = function () {

    introMusic.pause();
}

var PlayBattleMusic = function () {

    battleMusic.loop = true;
    battleMusic.play();
}

var StopBattleMusic = function () {

    battleMusic.pause();
}

var PlayBattleCry = function (character) {
    var soundClip;
    switch (character) {
        case "paladin":
            soundClip = new Audio("/public/sounds/Paladin_Cry.mp3");
            break;
        case "mage":
            soundClip = new Audio("/public/sounds/Mage_Cry.mp3");
            break;
        case "ranger":
            soundClip = new Audio("/public/sounds/Ranger_Cry.mp3");
            break;
        case "fighter":
            soundClip = new Audio("/public/sounds/Barbarian_Cry.mp3");
            break;
        default:
            soundClip = new Audio("/public/sounds/Barbarian_Cry.mp3");
            break;
...
Img.player.src = '/public/img/mage.png'
Img.fighter = new Image();
Img.fighter.src = '/public/img/fighter.png';
Img.ranger = new Image();
Img.ranger.src = '/public/img/ranger.png';
Img.paladin = new Image();
Img.paladin.src = '/public/img/paladin.png';
...
var Fighter = function (initPack) {
    ...
    self.draw = function () {
        ...
        var width = Img.fighter.width;
        var height = Img.fighter.height;

        ctx.drawImage(Img.fighter,
            0, 0, Img.fighter.width, Img.fighter.height,
            x - width / 2, y - height / 2, width, height);
    }
...
var Ranger = function (initPack) {
    ...
    self.draw = function () {
        ...
        var width = Img.ranger.width;
        var height = Img.ranger.height;

        ctx.drawImage(Img.ranger,
            0, 0, Img.ranger.width, Img.ranger.height,
            x - width / 2, y - height / 2, width, height);
    }
...
var Paladin = function (initPack) {
    ...
    self.draw = function () {
        ...
        var width = Img.paladin.width;
        var height = Img.paladin.height;

        ctx.drawImage(Img.paladin,
            0, 0, Img.paladin.width, Img.paladin.height,
            x - width / 2, y - height / 2, width, height);
    }
...
// Remove Package
// Notify public when player / attack is removed
